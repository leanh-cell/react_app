...
const AddressReceiverScreen = observer(({route, navigation}) => {
  ...
  const {infoAddressCustomers, callback} = route.params;
              ...
              <Row>
                ...
                <Column flex={0}>
                  {infoAddressCustomers == null ? (
                    ...
                    <IconCheck
                      size={15}
                      color={appTheme.color_main_1}></IconCheck>
                  ) : (
                    <></>
                  )}
    ...
    <Scaffold
      ...
      body={
        <ScrollView>
          ...
          <TouchableOpacity
            onPress={() => {
              navigation.navigate('NEW_ADDRESS', {callback: callback});
            }}>
            <Row
              padding={15}
...
export default AddressReceiverScreen;
